...
class CmcKernel:
    ...
    def QueryStrategyToBegin(self):
        """
        Input format: {card1},{card2},...
        Output format: {status};{Matter1}:[[strategy1],[...],] \n {Matter2}:[[...],],...
        """
        pass
    ...
    def ShowAllCanReactWith(self):
        """
        Input format: the name of a matter
        Output format: [...] list of matters
        """
        pass
