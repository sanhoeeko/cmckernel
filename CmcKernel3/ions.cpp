...
Cation::Cation(int id, const string& name, string& state, Real enthalpy, Real entropy, Real gibbs, int charge)
	: ConstMatter(id, name, state, enthalpy, entropy, gibbs)
{
	this->charge = charge;
}

Anion::Anion(int id, const string& name, string& state, Real enthalpy, Real entropy, Real gibbs, int charge)
	: ConstMatter(id, name, state, enthalpy, entropy, gibbs)
{
	this->charge = charge;
}
